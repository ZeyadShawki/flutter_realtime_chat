...
abstract class $UserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, int id, String username});
}
...
class _$_UserModel implements _UserModel {
  _$_UserModel({required this.email, required this.id, required this.username});
  ...
  @override
  String toString() {
    return 'UserModel(email: $email, id: $id, username: $username)';
  }
