...
abstract class $RegisterModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "password_confirmation") String confPassword});
}
...
class _$_RegisterModel implements _RegisterModel {
  _$_RegisterModel(
      ...
      @JsonKey(name: "password_confirmation") required this.confPassword});
  ...
  @override
  String toString() {
    return 'RegisterModel(username: $username, email: $email, password: $password, confPassword: $confPassword)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, email, password, confPassword);
...
abstract class _RegisterModel implements RegisterModel {
  factory _RegisterModel(
      ...
      @JsonKey(name: "password_confirmation")
      required final String confPassword}) = _$_RegisterModel;
